...
$totalRegistros = $modelo->contarMaterias();
$totalPaginas = ceil($totalRegistros / $limite);

// Obtener los maestros paginados
$materias = $modelo->obtenerPaginado($inicio, $limite);
            ...
            <tr>
                ...
                <td>
                    <button class="btn btn-warning btn-sm" 
                        onclick="abrirModal('<?= $materia['id'] ?>', '<?= htmlspecialchars($materia['nombre'], ENT_QUOTES) ?>')">
                        Editar
                    </button>
    ...
    <div class="modal fade" id="myModal">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form method="POST" action="Controladores/ctrl_materias.php">
                    <input type="hidden" name="id" id="Id_materia">
                    <div class="modal-body">
                        <div class="form-group">
                            <label>Nombre de la Materia</label>
                            <input type="text" class="form-control" name="nombre_materia" id="nombreMateria" required>
                        </div>
                    </div>
...
<script>
    ...
    function confirmarEliminacion(id) {
        if (confirm('¿Eliminar esta materia?')) {
            ...
            form.method = 'POST';
            form.action = 'Controladores/ctrl_materias.php';
