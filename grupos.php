...
$totalRegistros = $modeloGrupos->contarGrupos();
$totalPaginas = ceil($totalRegistros / $limite);

// Obtener los maestros paginados
$grupos = $modeloGrupos->obtenerPaginado($inicio, $limite);
    ...
    <table class="table table-striped">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= htmlspecialchars($grupo['carrera']) ?></td>
                <td>
    ...
    <div class="modal fade" id="myModal">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form method="POST" action="Controladores/ctrl_grupos.php">
                    <input type="hidden" name="id" id="Id_grupo">
                    <div class="modal-body">
                        <div class="form-group">
                            <label>Nombre del Grupo</label>
                            <input type="text" class="form-control" name="nombre_grupo" id="nombreGrupo" required>
                        </div>
                        <div class="form-group">
                            <label>Carrera</label>
                            <select class="form-control" name="carrera" id="selectCarrera" required>
...
<script>
    ...
    function confirmarEliminacion(id) {
        if (confirm('¿Eliminar este grupo?')) {
            ...
            form.method = 'POST';
            form.action = 'Controladores/ctrl_grupos.php';
