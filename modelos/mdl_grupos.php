...
class MdlGrupos {
    ...
    public function obtenerTodos() {
        try {
            return $this->conn->query("SELECT g.id_grupo as id, g.grupo, g.carrera as carrera_id, c.nombre as carrera 
                                    FROM $this->tabla g 
    ...
    public function obtenerPaginado($inicio, $limite) {
        $sql = "SELECT g.id_grupo as id, g.grupo, g.carrera as carrera_id, c.nombre as carrera 
                FROM $this->tabla g 
                JOIN carreras c ON g.carrera = c.id_carrera 
                WHERE g.activo = 0
                LIMIT :inicio, :limite";
